        ...
        Container(
          ...
          child: Column(
            children: [
              ...
              _BudgetRow(value: state.maxPrice ?? 500, onTap: () {}),
              const SizedBox(height: 12),
              _BudgetSlider(
...
class _BudgetRow extends StatelessWidget {
  const _BudgetRow({required this.value, required this.onTap});
    ...
    return Column(
      ...
      children: [
        ...
        SliderTheme(
          ...
          child: Slider(
            value: value,
            min: ManualFlightTripDetailsCard._budgetMin,
            max: ManualFlightTripDetailsCard._budgetMax,
            divisions: 39,
            onChanged: onChanged,
          ),
        ),
