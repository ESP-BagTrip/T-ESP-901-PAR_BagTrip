...
// Destination
 ...
 String get flightRoute; String get flightDetails; double get flightPrice; String get flightSource;// Day-by-day
 List<String> get dayProgram; List<String> get dayDescriptions; List<String> get dayCategories;// Baggage
 List<String> get essentialItems; List<String> get essentialReasons;// Budget breakdown
...
/// Create a copy of TripPlan
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? destinationCity = null,Object? destinationCountry = null,Object? destinationIata = freezed,Object? durationDays = null,Object? budgetEur = null,Object? highlights = null,Object? accommodationName = null,Object? accommodationSubtitle = null,Object? accommodationPrice = null,Object? accommodationSource = null,Object? flightRoute = null,Object? flightDetails = null,Object? flightPrice = null,Object? flightSource = null,Object? dayProgram = null,Object? dayDescriptions = null,Object? dayCategories = null,Object? essentialItems = null,Object? essentialReasons = null,Object? budgetBreakdown = null,Object? weatherData = null,}) {
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _TripPlan&&(identical(other.destinationCity, destinationCity) || other.destinationCity == destinationCity)&&(identical(other.destinationCountry, destinationCountry) || other.destinationCountry == destinationCountry)&&(identical(other.destinationIata, destinationIata) || other.destinationIata == destinationIata)&&(identical(other.durationDays, durationDays) || other.durationDays == durationDays)&&(identical(other.budgetEur, budgetEur) || other.budgetEur == budgetEur)&&const DeepCollectionEquality().equals(other._highlights, _highlights)&&(identical(other.accommodationName, accommodationName) || other.accommodationName == accommodationName)&&(identical(other.accommodationSubtitle, accommodationSubtitle) || other.accommodationSubtitle == accommodationSubtitle)&&(identical(other.accommodationPrice, accommodationPrice) || other.accommodationPrice == accommodationPrice)&&(identical(other.accommodationSource, accommodationSource) || other.accommodationSource == accommodationSource)&&(identical(other.flightRoute, flightRoute) || other.flightRoute == flightRoute)&&(identical(other.flightDetails, flightDetails) || other.flightDetails == flightDetails)&&(identical(other.flightPrice, flightPrice) || other.flightPrice == flightPrice)&&(identical(other.flightSource, flightSource) || other.flightSource == flightSource)&&const DeepCollectionEquality().equals(other._dayProgram, _dayProgram)&&const DeepCollectionEquality().equals(other._dayDescriptions, _dayDescriptions)&&const DeepCollectionEquality().equals(other._dayCategories, _dayCategories)&&const DeepCollectionEquality().equals(other._essentialItems, _essentialItems)&&const DeepCollectionEquality().equals(other._essentialReasons, _essentialReasons)&&const DeepCollectionEquality().equals(other._budgetBreakdown, _budgetBreakdown)&&const DeepCollectionEquality().equals(other._weatherData, _weatherData));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,destinationCity,destinationCountry,destinationIata,durationDays,budgetEur,const DeepCollectionEquality().hash(_highlights),accommodationName,accommodationSubtitle,accommodationPrice,accommodationSource,flightRoute,flightDetails,flightPrice,flightSource,const DeepCollectionEquality().hash(_dayProgram),const DeepCollectionEquality().hash(_dayDescriptions),const DeepCollectionEquality().hash(_dayCategories),const DeepCollectionEquality().hash(_essentialItems),const DeepCollectionEquality().hash(_essentialReasons),const DeepCollectionEquality().hash(_budgetBreakdown),const DeepCollectionEquality().hash(_weatherData)]);
