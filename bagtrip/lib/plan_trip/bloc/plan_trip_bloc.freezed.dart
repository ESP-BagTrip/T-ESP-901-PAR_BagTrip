...
class PlanTripSetTravelers implements PlanTripEvent {
  const PlanTripSetTravelers(this.count);
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$PlanTripSetTravelersCopyWith<PlanTripSetTravelers> get copyWith => _$PlanTripSetTravelersCopyWithImpl<PlanTripSetTravelers>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is PlanTripSetTravelers&&(identical(other.count, count) || other.count == count));
}
...
@override
String toString() {
  return 'PlanTripEvent.setTravelers(count: $count)';
}
...
/// @nodoc
abstract mixin class $PlanTripSetTravelersCopyWith<$Res> implements $PlanTripEventCopyWith<$Res> {
  factory $PlanTripSetTravelersCopyWith(PlanTripSetTravelers value, $Res Function(PlanTripSetTravelers) _then) = _$PlanTripSetTravelersCopyWithImpl;
@useResult
$Res call({
 int count
});
...
/// @nodoc
class _$PlanTripSetTravelersCopyWithImpl<$Res>
    implements $PlanTripSetTravelersCopyWith<$Res> {
  _$PlanTripSetTravelersCopyWithImpl(this._self, this._then);

  final PlanTripSetTravelers _self;
  final $Res Function(PlanTripSetTravelers) _then;

/// Create a copy of PlanTripEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? count = null,}) {
  return _then(PlanTripSetTravelers(
