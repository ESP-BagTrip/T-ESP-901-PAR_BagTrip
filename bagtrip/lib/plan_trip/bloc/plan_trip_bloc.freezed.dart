...
return backToProposals(_that);case _:
  return orElse();
...
// Navigation
 ...
 int get nbAdults; int get nbChildren; int get nbBabies; BudgetPreset? get budgetPreset;// Step 2 — Destination
...
@override
int get hashCode => Object.hashAll([runtimeType,currentStep,dateMode,startDate,endDate,preferredMonth,preferredYear,flexibleDuration,nbAdults,nbChildren,nbBabies,budgetPreset,const DeepCollectionEquality().hash(searchResults),isSearching,selectedManualDestination,const DeepCollectionEquality().hash(aiSuggestions),isLoadingAiSuggestions,selectedAiDestination,const DeepCollectionEquality().hash(generationSteps),generationProgress,generationMessage,generatedPlan,generationError,isCreating,createdTripId,isManualFlow,error]);

@override
String toString() {
  return 'PlanTripState(currentStep: $currentStep, dateMode: $dateMode, startDate: $startDate, endDate: $endDate, preferredMonth: $preferredMonth, preferredYear: $preferredYear, flexibleDuration: $flexibleDuration, nbAdults: $nbAdults, nbChildren: $nbChildren, nbBabies: $nbBabies, budgetPreset: $budgetPreset, searchResults: $searchResults, isSearching: $isSearching, selectedManualDestination: $selectedManualDestination, aiSuggestions: $aiSuggestions, isLoadingAiSuggestions: $isLoadingAiSuggestions, selectedAiDestination: $selectedAiDestination, generationSteps: $generationSteps, generationProgress: $generationProgress, generationMessage: $generationMessage, generatedPlan: $generatedPlan, generationError: $generationError, isCreating: $isCreating, createdTripId: $createdTripId, isManualFlow: $isManualFlow, error: $error)';
}
...
@useResult
$Res call({
 int currentStep, DateMode dateMode, DateTime? startDate, DateTime? endDate, int? preferredMonth, int? preferredYear, DurationPreset? flexibleDuration, int nbAdults, int nbChildren, int nbBabies, BudgetPreset? budgetPreset, List<LocationResult> searchResults, bool isSearching, LocationResult? selectedManualDestination, List<AiDestination> aiSuggestions, bool isLoadingAiSuggestions, AiDestination? selectedAiDestination, Map<String, StepStatus> generationSteps, double generationProgress, String? generationMessage, TripPlan? generatedPlan, String? generationError, bool isCreating, String? createdTripId, bool isManualFlow, String? error
});
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int currentStep,  DateMode dateMode,  DateTime? startDate,  DateTime? endDate,  int? preferredMonth,  int? preferredYear,  DurationPreset? flexibleDuration,  int nbAdults,  int nbChildren,  int nbBabies,  BudgetPreset? budgetPreset,  List<LocationResult> searchResults,  bool isSearching,  LocationResult? selectedManualDestination,  List<AiDestination> aiSuggestions,  bool isLoadingAiSuggestions,  AiDestination? selectedAiDestination,  Map<String, StepStatus> generationSteps,  double generationProgress,  String? generationMessage,  TripPlan? generatedPlan,  String? generationError,  bool isCreating,  String? createdTripId,  bool isManualFlow,  String? error)  $default,) {final _that = this;
switch (_that) {
case _PlanTripState():
return $default(_that.currentStep,_that.dateMode,_that.startDate,_that.endDate,_that.preferredMonth,_that.preferredYear,_that.flexibleDuration,_that.nbAdults,_that.nbChildren,_that.nbBabies,_that.budgetPreset,_that.searchResults,_that.isSearching,_that.selectedManualDestination,_that.aiSuggestions,_that.isLoadingAiSuggestions,_that.selectedAiDestination,_that.generationSteps,_that.generationProgress,_that.generationMessage,_that.generatedPlan,_that.generationError,_that.isCreating,_that.createdTripId,_that.isManualFlow,_that.error);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int currentStep,  DateMode dateMode,  DateTime? startDate,  DateTime? endDate,  int? preferredMonth,  int? preferredYear,  DurationPreset? flexibleDuration,  int nbAdults,  int nbChildren,  int nbBabies,  BudgetPreset? budgetPreset,  List<LocationResult> searchResults,  bool isSearching,  LocationResult? selectedManualDestination,  List<AiDestination> aiSuggestions,  bool isLoadingAiSuggestions,  AiDestination? selectedAiDestination,  Map<String, StepStatus> generationSteps,  double generationProgress,  String? generationMessage,  TripPlan? generatedPlan,  String? generationError,  bool isCreating,  String? createdTripId,  bool isManualFlow,  String? error)?  $default,) {final _that = this;
switch (_that) {
case _PlanTripState() when $default != null:
return $default(_that.currentStep,_that.dateMode,_that.startDate,_that.endDate,_that.preferredMonth,_that.preferredYear,_that.flexibleDuration,_that.nbAdults,_that.nbChildren,_that.nbBabies,_that.budgetPreset,_that.searchResults,_that.isSearching,_that.selectedManualDestination,_that.aiSuggestions,_that.isLoadingAiSuggestions,_that.selectedAiDestination,_that.generationSteps,_that.generationProgress,_that.generationMessage,_that.generatedPlan,_that.generationError,_that.isCreating,_that.createdTripId,_that.isManualFlow,_that.error);case _:
  return null;
...
@override
int get hashCode => Object.hashAll([runtimeType,currentStep,dateMode,startDate,endDate,preferredMonth,preferredYear,flexibleDuration,nbAdults,nbChildren,nbBabies,budgetPreset,const DeepCollectionEquality().hash(_searchResults),isSearching,selectedManualDestination,const DeepCollectionEquality().hash(_aiSuggestions),isLoadingAiSuggestions,selectedAiDestination,const DeepCollectionEquality().hash(_generationSteps),generationProgress,generationMessage,generatedPlan,generationError,isCreating,createdTripId,isManualFlow,error]);
