...
return selectManualDestination(_that);case PlanTripApplyPrefill() when applyPrefill != null:
return applyPrefill(_that);case PlanTripRequestAiSuggestions() when requestAiSuggestions != null:
...
return selectManualDestination(_that);case PlanTripApplyPrefill():
return applyPrefill(_that);case PlanTripRequestAiSuggestions():
...
return selectManualDestination(_that.location);case PlanTripApplyPrefill() when applyPrefill != null:
return applyPrefill(_that.prefill);case PlanTripRequestAiSuggestions() when requestAiSuggestions != null:
...
return selectManualDestination(_that.location);case PlanTripApplyPrefill():
return applyPrefill(_that.prefill);case PlanTripRequestAiSuggestions():
...
class PlanTripApplyPrefill implements PlanTripEvent {
  const PlanTripApplyPrefill(this.prefill);
  

 final  PlanTripPrefill prefill;

/// Create a copy of PlanTripEvent
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$PlanTripApplyPrefillCopyWith<PlanTripApplyPrefill> get copyWith => _$PlanTripApplyPrefillCopyWithImpl<PlanTripApplyPrefill>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is PlanTripApplyPrefill&&(identical(other.prefill, prefill) || other.prefill == prefill));
}


@override
int get hashCode => Object.hash(runtimeType,prefill);

@override
String toString() {
  return 'PlanTripEvent.applyPrefill(prefill: $prefill)';
}
...
/// @nodoc
abstract mixin class $PlanTripApplyPrefillCopyWith<$Res> implements $PlanTripEventCopyWith<$Res> {
  factory $PlanTripApplyPrefillCopyWith(PlanTripApplyPrefill value, $Res Function(PlanTripApplyPrefill) _then) = _$PlanTripApplyPrefillCopyWithImpl;
@useResult
$Res call({
 PlanTripPrefill prefill
});
...
/// @nodoc
class _$PlanTripApplyPrefillCopyWithImpl<$Res>
    implements $PlanTripApplyPrefillCopyWith<$Res> {
  _$PlanTripApplyPrefillCopyWithImpl(this._self, this._then);

  final PlanTripApplyPrefill _self;
  final $Res Function(PlanTripApplyPrefill) _then;

/// Create a copy of PlanTripEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? prefill = null,}) {
  return _then(PlanTripApplyPrefill(
null == prefill ? _self.prefill : prefill // ignore: cast_nullable_to_non_nullable
as PlanTripPrefill,
  ));
}
...
// Navigation
 ...
 int get nbAdults; int get nbChildren; int get nbBabies; BudgetPreset? get budgetPreset;// Topic 01 (B2/B6/B7) — numeric target derived from the preset at
// step-2 entry. Stored in state so the wizard, the SSE payload and
// the trip detail render the *same* number end-to-end.
 double? get targetBudget; String? get originCity; List<LocationResult> get originSearchResults;// Step 2 — Destination
 ...
 Map<String, StepStatus> get generationSteps; double get generationProgress; String? get generationMessage; TripPlan? get generatedPlan; String? get generationError;// Server persists the DRAFT trip during the SSE run; the ``tripId``
...
// ``createdTripId`` without re-calling the backend.
 String? get pendingTripId;// Non-fatal SSE warnings (Amadeus down, weather unavailable…). The
// review screen surfaces them as a soft banner.
 List<String> get generationWarnings;// Step 5 — Review / Creation
 bool get isCreating; String? get createdTripId;// SMP-324 — DRAFT trip persisted by the SSE pipeline. ``createdTripId``
...
@useResult
$Res call({
 int currentStep, DateMode dateMode, DateTime? startDate, DateTime? endDate, int? preferredMonth, int? preferredYear, DurationPreset? flexibleDuration, int nbAdults, int nbChildren, int nbBabies, BudgetPreset? budgetPreset, double? targetBudget, String? originCity, List<LocationResult> originSearchResults, List<LocationResult> searchResults, bool isSearching, LocationResult? selectedManualDestination, List<AiDestination> aiSuggestions, bool isLoadingAiSuggestions, AiDestination? selectedAiDestination, Map<String, StepStatus> generationSteps, double generationProgress, String? generationMessage, TripPlan? generatedPlan, String? generationError, String? pendingTripId, List<String> generationWarnings, bool isCreating, String? createdTripId, String? draftTripId, bool isManualFlow, AppError? error
});
...
as BudgetPreset?,targetBudget: freezed == targetBudget ? _self.targetBudget : targetBudget // ignore: cast_nullable_to_non_nullable
as double?,originCity: freezed == originCity ? _self.originCity : originCity // ignore: cast_nullable_to_non_nullable
...
as String?,pendingTripId: freezed == pendingTripId ? _self.pendingTripId : pendingTripId // ignore: cast_nullable_to_non_nullable
as String?,generationWarnings: null == generationWarnings ? _self.generationWarnings : generationWarnings // ignore: cast_nullable_to_non_nullable
as List<String>,isCreating: null == isCreating ? _self.isCreating : isCreating // ignore: cast_nullable_to_non_nullable
as bool,createdTripId: freezed == createdTripId ? _self.createdTripId : createdTripId // ignore: cast_nullable_to_non_nullable
as String?,draftTripId: freezed == draftTripId ? _self.draftTripId : draftTripId // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int currentStep,  DateMode dateMode,  DateTime? startDate,  DateTime? endDate,  int? preferredMonth,  int? preferredYear,  DurationPreset? flexibleDuration,  int nbAdults,  int nbChildren,  int nbBabies,  BudgetPreset? budgetPreset,  double? targetBudget,  String? originCity,  List<LocationResult> originSearchResults,  List<LocationResult> searchResults,  bool isSearching,  LocationResult? selectedManualDestination,  List<AiDestination> aiSuggestions,  bool isLoadingAiSuggestions,  AiDestination? selectedAiDestination,  Map<String, StepStatus> generationSteps,  double generationProgress,  String? generationMessage,  TripPlan? generatedPlan,  String? generationError,  String? pendingTripId,  List<String> generationWarnings,  bool isCreating,  String? createdTripId,  String? draftTripId,  bool isManualFlow,  AppError? error)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _PlanTripState() when $default != null:
return $default(_that.currentStep,_that.dateMode,_that.startDate,_that.endDate,_that.preferredMonth,_that.preferredYear,_that.flexibleDuration,_that.nbAdults,_that.nbChildren,_that.nbBabies,_that.budgetPreset,_that.targetBudget,_that.originCity,_that.originSearchResults,_that.searchResults,_that.isSearching,_that.selectedManualDestination,_that.aiSuggestions,_that.isLoadingAiSuggestions,_that.selectedAiDestination,_that.generationSteps,_that.generationProgress,_that.generationMessage,_that.generatedPlan,_that.generationError,_that.pendingTripId,_that.generationWarnings,_that.isCreating,_that.createdTripId,_that.draftTripId,_that.isManualFlow,_that.error);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int currentStep,  DateMode dateMode,  DateTime? startDate,  DateTime? endDate,  int? preferredMonth,  int? preferredYear,  DurationPreset? flexibleDuration,  int nbAdults,  int nbChildren,  int nbBabies,  BudgetPreset? budgetPreset,  double? targetBudget,  String? originCity,  List<LocationResult> originSearchResults,  List<LocationResult> searchResults,  bool isSearching,  LocationResult? selectedManualDestination,  List<AiDestination> aiSuggestions,  bool isLoadingAiSuggestions,  AiDestination? selectedAiDestination,  Map<String, StepStatus> generationSteps,  double generationProgress,  String? generationMessage,  TripPlan? generatedPlan,  String? generationError,  String? pendingTripId,  List<String> generationWarnings,  bool isCreating,  String? createdTripId,  String? draftTripId,  bool isManualFlow,  AppError? error)  $default,) {final _that = this;
switch (_that) {
case _PlanTripState():
return $default(_that.currentStep,_that.dateMode,_that.startDate,_that.endDate,_that.preferredMonth,_that.preferredYear,_that.flexibleDuration,_that.nbAdults,_that.nbChildren,_that.nbBabies,_that.budgetPreset,_that.targetBudget,_that.originCity,_that.originSearchResults,_that.searchResults,_that.isSearching,_that.selectedManualDestination,_that.aiSuggestions,_that.isLoadingAiSuggestions,_that.selectedAiDestination,_that.generationSteps,_that.generationProgress,_that.generationMessage,_that.generatedPlan,_that.generationError,_that.pendingTripId,_that.generationWarnings,_that.isCreating,_that.createdTripId,_that.draftTripId,_that.isManualFlow,_that.error);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int currentStep,  DateMode dateMode,  DateTime? startDate,  DateTime? endDate,  int? preferredMonth,  int? preferredYear,  DurationPreset? flexibleDuration,  int nbAdults,  int nbChildren,  int nbBabies,  BudgetPreset? budgetPreset,  double? targetBudget,  String? originCity,  List<LocationResult> originSearchResults,  List<LocationResult> searchResults,  bool isSearching,  LocationResult? selectedManualDestination,  List<AiDestination> aiSuggestions,  bool isLoadingAiSuggestions,  AiDestination? selectedAiDestination,  Map<String, StepStatus> generationSteps,  double generationProgress,  String? generationMessage,  TripPlan? generatedPlan,  String? generationError,  String? pendingTripId,  List<String> generationWarnings,  bool isCreating,  String? createdTripId,  String? draftTripId,  bool isManualFlow,  AppError? error)?  $default,) {final _that = this;
switch (_that) {
case _PlanTripState() when $default != null:
return $default(_that.currentStep,_that.dateMode,_that.startDate,_that.endDate,_that.preferredMonth,_that.preferredYear,_that.flexibleDuration,_that.nbAdults,_that.nbChildren,_that.nbBabies,_that.budgetPreset,_that.targetBudget,_that.originCity,_that.originSearchResults,_that.searchResults,_that.isSearching,_that.selectedManualDestination,_that.aiSuggestions,_that.isLoadingAiSuggestions,_that.selectedAiDestination,_that.generationSteps,_that.generationProgress,_that.generationMessage,_that.generatedPlan,_that.generationError,_that.pendingTripId,_that.generationWarnings,_that.isCreating,_that.createdTripId,_that.draftTripId,_that.isManualFlow,_that.error);case _:
  return null;
...
class _PlanTripState extends PlanTripState {
  const _PlanTripState({this.currentStep = 0, this.dateMode = DateMode.exact, this.startDate, this.endDate, this.preferredMonth, this.preferredYear, this.flexibleDuration, this.nbAdults = 1, this.nbChildren = 0, this.nbBabies = 0, this.budgetPreset, this.targetBudget, this.originCity, final  List<LocationResult> originSearchResults = const [], final  List<LocationResult> searchResults = const [], this.isSearching = false, this.selectedManualDestination, final  List<AiDestination> aiSuggestions = const [], this.isLoadingAiSuggestions = false, this.selectedAiDestination, final  Map<String, StepStatus> generationSteps = const {}, this.generationProgress = 0.0, this.generationMessage, this.generatedPlan, this.generationError, this.pendingTripId, final  List<String> generationWarnings = const <String>[], this.isCreating = false, this.createdTripId, this.draftTripId, this.isManualFlow = false, this.error}): _originSearchResults = originSearchResults,_searchResults = searchResults,_aiSuggestions = aiSuggestions,_generationSteps = generationSteps,_generationWarnings = generationWarnings,super._();
...
// step-2 entry. Stored in state so the wizard, the SSE payload and
// the trip detail render the *same* number end-to-end.
@override final  double? targetBudget;
...
// "Create my trip" button on step 5 just promotes it to
// ``createdTripId`` without re-calling the backend.
@override final  String? pendingTripId;
// Non-fatal SSE warnings (Amadeus down, weather unavailable…). The
// review screen surfaces them as a soft banner.
 final  List<String> _generationWarnings;
// Non-fatal SSE warnings (Amadeus down, weather unavailable…). The
// review screen surfaces them as a soft banner.
@override@JsonKey() List<String> get generationWarnings {
  if (_generationWarnings is EqualUnmodifiableListView) return _generationWarnings;
  // ignore: implicit_dynamic_type
  return EqualUnmodifiableListView(_generationWarnings);
}
...
// tracks the row that already exists in DB so the wizard can confirm
// it via ``PATCH /trips/{id}/status`` or discard it via ``DELETE``.
@override final  String? draftTripId;
// Meta
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _PlanTripState&&(identical(other.currentStep, currentStep) || other.currentStep == currentStep)&&(identical(other.dateMode, dateMode) || other.dateMode == dateMode)&&(identical(other.startDate, startDate) || other.startDate == startDate)&&(identical(other.endDate, endDate) || other.endDate == endDate)&&(identical(other.preferredMonth, preferredMonth) || other.preferredMonth == preferredMonth)&&(identical(other.preferredYear, preferredYear) || other.preferredYear == preferredYear)&&(identical(other.flexibleDuration, flexibleDuration) || other.flexibleDuration == flexibleDuration)&&(identical(other.nbAdults, nbAdults) || other.nbAdults == nbAdults)&&(identical(other.nbChildren, nbChildren) || other.nbChildren == nbChildren)&&(identical(other.nbBabies, nbBabies) || other.nbBabies == nbBabies)&&(identical(other.budgetPreset, budgetPreset) || other.budgetPreset == budgetPreset)&&(identical(other.targetBudget, targetBudget) || other.targetBudget == targetBudget)&&(identical(other.originCity, originCity) || other.originCity == originCity)&&const DeepCollectionEquality().equals(other._originSearchResults, _originSearchResults)&&const DeepCollectionEquality().equals(other._searchResults, _searchResults)&&(identical(other.isSearching, isSearching) || other.isSearching == isSearching)&&(identical(other.selectedManualDestination, selectedManualDestination) || other.selectedManualDestination == selectedManualDestination)&&const DeepCollectionEquality().equals(other._aiSuggestions, _aiSuggestions)&&(identical(other.isLoadingAiSuggestions, isLoadingAiSuggestions) || other.isLoadingAiSuggestions == isLoadingAiSuggestions)&&(identical(other.selectedAiDestination, selectedAiDestination) || other.selectedAiDestination == selectedAiDestination)&&const DeepCollectionEquality().equals(other._generationSteps, _generationSteps)&&(identical(other.generationProgress, generationProgress) || other.generationProgress == generationProgress)&&(identical(other.generationMessage, generationMessage) || other.generationMessage == generationMessage)&&(identical(other.generatedPlan, generatedPlan) || other.generatedPlan == generatedPlan)&&(identical(other.generationError, generationError) || other.generationError == generationError)&&(identical(other.pendingTripId, pendingTripId) || other.pendingTripId == pendingTripId)&&const DeepCollectionEquality().equals(other._generationWarnings, _generationWarnings)&&(identical(other.isCreating, isCreating) || other.isCreating == isCreating)&&(identical(other.createdTripId, createdTripId) || other.createdTripId == createdTripId)&&(identical(other.draftTripId, draftTripId) || other.draftTripId == draftTripId)&&(identical(other.isManualFlow, isManualFlow) || other.isManualFlow == isManualFlow)&&(identical(other.error, error) || other.error == error));
}


@override
int get hashCode => Object.hashAll([runtimeType,currentStep,dateMode,startDate,endDate,preferredMonth,preferredYear,flexibleDuration,nbAdults,nbChildren,nbBabies,budgetPreset,targetBudget,originCity,const DeepCollectionEquality().hash(_originSearchResults),const DeepCollectionEquality().hash(_searchResults),isSearching,selectedManualDestination,const DeepCollectionEquality().hash(_aiSuggestions),isLoadingAiSuggestions,selectedAiDestination,const DeepCollectionEquality().hash(_generationSteps),generationProgress,generationMessage,generatedPlan,generationError,pendingTripId,const DeepCollectionEquality().hash(_generationWarnings),isCreating,createdTripId,draftTripId,isManualFlow,error]);
...
as TripPlan?,generationError: freezed == generationError ? _self.generationError : generationError // ignore: cast_nullable_to_non_nullable
as String?,pendingTripId: freezed == pendingTripId ? _self.pendingTripId : pendingTripId // ignore: cast_nullable_to_non_nullable
as String?,generationWarnings: null == generationWarnings ? _self._generationWarnings : generationWarnings // ignore: cast_nullable_to_non_nullable
as List<String>,isCreating: null == isCreating ? _self.isCreating : isCreating // ignore: cast_nullable_to_non_nullable
as bool,createdTripId: freezed == createdTripId ? _self.createdTripId : createdTripId // ignore: cast_nullable_to_non_nullable
as String?,draftTripId: freezed == draftTripId ? _self.draftTripId : draftTripId // ignore: cast_nullable_to_non_nullable
as String?,isManualFlow: null == isManualFlow ? _self.isManualFlow : isManualFlow // ignore: cast_nullable_to_non_nullable
