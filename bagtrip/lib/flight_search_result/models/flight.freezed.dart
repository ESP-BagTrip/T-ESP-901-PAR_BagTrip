...
@JsonKey(name: 'numberOfBookableSeats') int get numberOfBookableSeats;@JsonKey(name: 'lastTicketingDate') String get lastTicketingDate;@JsonKey(name: 'basePrice') double get basePrice;@JsonKey(name: 'cabinClass') String get cabinClass;@JsonKey(name: 'bookingClass') String get bookingClass;@JsonKey(name: 'fareBasis') String get fareBasis;@JsonKey(name: 'checkedBags') BaggageInfo? get checkedBags;@JsonKey(name: 'cabinBags') BaggageInfo? get cabinBags;// Booking context (set when search is tied to a trip)
@JsonKey(name: 'trip_id') String? get tripId;@JsonKey(name: 'flight_offer_id') String? get flightOfferId;
...
as BaggageInfo?,tripId: freezed == tripId ? _self.tripId : tripId // ignore: cast_nullable_to_non_nullable
as String?,flightOfferId: freezed == flightOfferId ? _self.flightOfferId : flightOfferId // ignore: cast_nullable_to_non_nullable
as String?,
  ));
}
/// Create a copy of Flight
...
@override@JsonKey(name: 'flight_offer_id') final  String? flightOfferId;
