...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,userId,title,originIata,destinationIata,startDate,endDate,status,description,destinationName,destinationTimezone,nbTravelers,coverImageUrl,budgetTarget,budgetEstimated,budgetActual,origin,role,completionPercentage,flightsTracking,accommodationsTracking,createdAt,updatedAt]);

@override
String toString() {
  return 'Trip(id: $id, userId: $userId, title: $title, originIata: $originIata, destinationIata: $destinationIata, startDate: $startDate, endDate: $endDate, status: $status, description: $description, destinationName: $destinationName, destinationTimezone: $destinationTimezone, nbTravelers: $nbTravelers, coverImageUrl: $coverImageUrl, budgetTarget: $budgetTarget, budgetEstimated: $budgetEstimated, budgetActual: $budgetActual, origin: $origin, role: $role, completionPercentage: $completionPercentage, flightsTracking: $flightsTracking, accommodationsTracking: $accommodationsTracking, createdAt: $createdAt, updatedAt: $updatedAt)';
}
...
/// Create a copy of Trip
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? userId = freezed,Object? title = freezed,Object? originIata = freezed,Object? destinationIata = freezed,Object? startDate = freezed,Object? endDate = freezed,Object? status = null,Object? description = freezed,Object? destinationName = freezed,Object? destinationTimezone = freezed,Object? nbTravelers = freezed,Object? coverImageUrl = freezed,Object? budgetTarget = freezed,Object? budgetEstimated = freezed,Object? budgetActual = freezed,Object? origin = freezed,Object? role = freezed,Object? completionPercentage = null,Object? flightsTracking = null,Object? accommodationsTracking = null,Object? createdAt = freezed,Object? updatedAt = freezed,}) {
...
class _Trip implements Trip {
  const _Trip({required this.id, this.userId, this.title, this.originIata, this.destinationIata, this.startDate, this.endDate, @TripStatusConverter() this.status = TripStatus.draft, this.description, @JsonKey(name: 'destination_name') this.destinationName, this.destinationTimezone, this.nbTravelers, this.coverImageUrl, this.budgetTarget, this.budgetEstimated, this.budgetActual, this.origin, this.role, this.completionPercentage = 0, this.flightsTracking = 'TRACKED', this.accommodationsTracking = 'TRACKED', this.createdAt, this.updatedAt});
