...
// the "Change cover" bottom sheet shows; null on legacy trips.
 String? get coverImageSource; List<TripCoverCandidate> get coverImageCandidates; double? get budgetTarget; double? get budgetEstimated; double? get budgetActual; String? get origin; String? get role; int get completionPercentage; String get flightsTracking; String get accommodationsTracking; DateTime? get createdAt; DateTime? get updatedAt;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Trip&&(identical(other.id, id) || other.id == id)&&(identical(other.userId, userId) || other.userId == userId)&&(identical(other.title, title) || other.title == title)&&(identical(other.originIata, originIata) || other.originIata == originIata)&&(identical(other.destinationIata, destinationIata) || other.destinationIata == destinationIata)&&(identical(other.startDate, startDate) || other.startDate == startDate)&&(identical(other.endDate, endDate) || other.endDate == endDate)&&(identical(other.status, status) || other.status == status)&&(identical(other.description, description) || other.description == description)&&(identical(other.destinationName, destinationName) || other.destinationName == destinationName)&&(identical(other.destinationTimezone, destinationTimezone) || other.destinationTimezone == destinationTimezone)&&(identical(other.destinationLatitude, destinationLatitude) || other.destinationLatitude == destinationLatitude)&&(identical(other.destinationLongitude, destinationLongitude) || other.destinationLongitude == destinationLongitude)&&(identical(other.nbTravelers, nbTravelers) || other.nbTravelers == nbTravelers)&&(identical(other.coverImageUrl, coverImageUrl) || other.coverImageUrl == coverImageUrl)&&(identical(other.coverImageSource, coverImageSource) || other.coverImageSource == coverImageSource)&&const DeepCollectionEquality().equals(other.coverImageCandidates, coverImageCandidates)&&(identical(other.budgetTarget, budgetTarget) || other.budgetTarget == budgetTarget)&&(identical(other.budgetEstimated, budgetEstimated) || other.budgetEstimated == budgetEstimated)&&(identical(other.budgetActual, budgetActual) || other.budgetActual == budgetActual)&&(identical(other.origin, origin) || other.origin == origin)&&(identical(other.role, role) || other.role == role)&&(identical(other.completionPercentage, completionPercentage) || other.completionPercentage == completionPercentage)&&(identical(other.flightsTracking, flightsTracking) || other.flightsTracking == flightsTracking)&&(identical(other.accommodationsTracking, accommodationsTracking) || other.accommodationsTracking == accommodationsTracking)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&(identical(other.updatedAt, updatedAt) || other.updatedAt == updatedAt));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,userId,title,originIata,destinationIata,startDate,endDate,status,description,destinationName,destinationTimezone,destinationLatitude,destinationLongitude,nbTravelers,coverImageUrl,coverImageSource,const DeepCollectionEquality().hash(coverImageCandidates),budgetTarget,budgetEstimated,budgetActual,origin,role,completionPercentage,flightsTracking,accommodationsTracking,createdAt,updatedAt]);

@override
String toString() {
  return 'Trip(id: $id, userId: $userId, title: $title, originIata: $originIata, destinationIata: $destinationIata, startDate: $startDate, endDate: $endDate, status: $status, description: $description, destinationName: $destinationName, destinationTimezone: $destinationTimezone, destinationLatitude: $destinationLatitude, destinationLongitude: $destinationLongitude, nbTravelers: $nbTravelers, coverImageUrl: $coverImageUrl, coverImageSource: $coverImageSource, coverImageCandidates: $coverImageCandidates, budgetTarget: $budgetTarget, budgetEstimated: $budgetEstimated, budgetActual: $budgetActual, origin: $origin, role: $role, completionPercentage: $completionPercentage, flightsTracking: $flightsTracking, accommodationsTracking: $accommodationsTracking, createdAt: $createdAt, updatedAt: $updatedAt)';
}
...
@useResult
$Res call({
 String id, String? userId, String? title, String? originIata, String? destinationIata, DateTime? startDate, DateTime? endDate,@TripStatusConverter() TripStatus status, String? description,@JsonKey(name: 'destination_name') String? destinationName, String? destinationTimezone, double? destinationLatitude, double? destinationLongitude, int? nbTravelers, String? coverImageUrl, String? coverImageSource, List<TripCoverCandidate> coverImageCandidates, double? budgetTarget, double? budgetEstimated, double? budgetActual, String? origin, String? role, int completionPercentage, String flightsTracking, String accommodationsTracking, DateTime? createdAt, DateTime? updatedAt
});
...
/// Create a copy of Trip
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? userId = freezed,Object? title = freezed,Object? originIata = freezed,Object? destinationIata = freezed,Object? startDate = freezed,Object? endDate = freezed,Object? status = null,Object? description = freezed,Object? destinationName = freezed,Object? destinationTimezone = freezed,Object? destinationLatitude = freezed,Object? destinationLongitude = freezed,Object? nbTravelers = freezed,Object? coverImageUrl = freezed,Object? coverImageSource = freezed,Object? coverImageCandidates = null,Object? budgetTarget = freezed,Object? budgetEstimated = freezed,Object? budgetActual = freezed,Object? origin = freezed,Object? role = freezed,Object? completionPercentage = null,Object? flightsTracking = null,Object? accommodationsTracking = null,Object? createdAt = freezed,Object? updatedAt = freezed,}) {
...
as String?,destinationTimezone: freezed == destinationTimezone ? _self.destinationTimezone : destinationTimezone // ignore: cast_nullable_to_non_nullable
as String?,destinationLatitude: freezed == destinationLatitude ? _self.destinationLatitude : destinationLatitude // ignore: cast_nullable_to_non_nullable
...
as double?,nbTravelers: freezed == nbTravelers ? _self.nbTravelers : nbTravelers // ignore: cast_nullable_to_non_nullable
as int?,coverImageUrl: freezed == coverImageUrl ? _self.coverImageUrl : coverImageUrl // ignore: cast_nullable_to_non_nullable
as String?,coverImageSource: freezed == coverImageSource ? _self.coverImageSource : coverImageSource // ignore: cast_nullable_to_non_nullable
as String?,coverImageCandidates: null == coverImageCandidates ? _self.coverImageCandidates : coverImageCandidates // ignore: cast_nullable_to_non_nullable
as List<TripCoverCandidate>,budgetTarget: freezed == budgetTarget ? _self.budgetTarget : budgetTarget // ignore: cast_nullable_to_non_nullable
as double?,budgetEstimated: freezed == budgetEstimated ? _self.budgetEstimated : budgetEstimated // ignore: cast_nullable_to_non_nullable
as double?,budgetActual: freezed == budgetActual ? _self.budgetActual : budgetActual // ignore: cast_nullable_to_non_nullable
...
switch (_that) {
case _Trip() when $default != null:
return $default(_that.id,_that.userId,_that.title,_that.originIata,_that.destinationIata,_that.startDate,_that.endDate,_that.status,_that.description,_that.destinationName,_that.destinationTimezone,_that.destinationLatitude,_that.destinationLongitude,_that.nbTravelers,_that.coverImageUrl,_that.coverImageSource,_that.coverImageCandidates,_that.budgetTarget,_that.budgetEstimated,_that.budgetActual,_that.origin,_that.role,_that.completionPercentage,_that.flightsTracking,_that.accommodationsTracking,_that.createdAt,_that.updatedAt);case _:
  return orElse();
...
class _Trip implements Trip {
  const _Trip({required this.id, this.userId, this.title, this.originIata, this.destinationIata, this.startDate, this.endDate, @TripStatusConverter() this.status = TripStatus.draft, this.description, @JsonKey(name: 'destination_name') this.destinationName, this.destinationTimezone, this.destinationLatitude, this.destinationLongitude, this.nbTravelers, this.coverImageUrl, this.coverImageSource, final  List<TripCoverCandidate> coverImageCandidates = const <TripCoverCandidate>[], this.budgetTarget, this.budgetEstimated, this.budgetActual, this.origin, this.role, this.completionPercentage = 0, this.flightsTracking = 'TRACKED', this.accommodationsTracking = 'TRACKED', this.createdAt, this.updatedAt}): _coverImageCandidates = coverImageCandidates;
...
@override final  String? destinationTimezone;
@override final  double? destinationLatitude;
...
// ``user_selected``, ``unsplash_legacy``. ``candidates`` is the list
// the "Change cover" bottom sheet shows; null on legacy trips.
@override final  String? coverImageSource;
 final  List<TripCoverCandidate> _coverImageCandidates;
@override@JsonKey() List<TripCoverCandidate> get coverImageCandidates {
  if (_coverImageCandidates is EqualUnmodifiableListView) return _coverImageCandidates;
  // ignore: implicit_dynamic_type
  return EqualUnmodifiableListView(_coverImageCandidates);
}

@override final  double? budgetTarget;
@override final  double? budgetEstimated;
@override final  double? budgetActual;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Trip&&(identical(other.id, id) || other.id == id)&&(identical(other.userId, userId) || other.userId == userId)&&(identical(other.title, title) || other.title == title)&&(identical(other.originIata, originIata) || other.originIata == originIata)&&(identical(other.destinationIata, destinationIata) || other.destinationIata == destinationIata)&&(identical(other.startDate, startDate) || other.startDate == startDate)&&(identical(other.endDate, endDate) || other.endDate == endDate)&&(identical(other.status, status) || other.status == status)&&(identical(other.description, description) || other.description == description)&&(identical(other.destinationName, destinationName) || other.destinationName == destinationName)&&(identical(other.destinationTimezone, destinationTimezone) || other.destinationTimezone == destinationTimezone)&&(identical(other.destinationLatitude, destinationLatitude) || other.destinationLatitude == destinationLatitude)&&(identical(other.destinationLongitude, destinationLongitude) || other.destinationLongitude == destinationLongitude)&&(identical(other.nbTravelers, nbTravelers) || other.nbTravelers == nbTravelers)&&(identical(other.coverImageUrl, coverImageUrl) || other.coverImageUrl == coverImageUrl)&&(identical(other.coverImageSource, coverImageSource) || other.coverImageSource == coverImageSource)&&const DeepCollectionEquality().equals(other._coverImageCandidates, _coverImageCandidates)&&(identical(other.budgetTarget, budgetTarget) || other.budgetTarget == budgetTarget)&&(identical(other.budgetEstimated, budgetEstimated) || other.budgetEstimated == budgetEstimated)&&(identical(other.budgetActual, budgetActual) || other.budgetActual == budgetActual)&&(identical(other.origin, origin) || other.origin == origin)&&(identical(other.role, role) || other.role == role)&&(identical(other.completionPercentage, completionPercentage) || other.completionPercentage == completionPercentage)&&(identical(other.flightsTracking, flightsTracking) || other.flightsTracking == flightsTracking)&&(identical(other.accommodationsTracking, accommodationsTracking) || other.accommodationsTracking == accommodationsTracking)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&(identical(other.updatedAt, updatedAt) || other.updatedAt == updatedAt));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,userId,title,originIata,destinationIata,startDate,endDate,status,description,destinationName,destinationTimezone,destinationLatitude,destinationLongitude,nbTravelers,coverImageUrl,coverImageSource,const DeepCollectionEquality().hash(_coverImageCandidates),budgetTarget,budgetEstimated,budgetActual,origin,role,completionPercentage,flightsTracking,accommodationsTracking,createdAt,updatedAt]);
...
as int?,coverImageUrl: freezed == coverImageUrl ? _self.coverImageUrl : coverImageUrl // ignore: cast_nullable_to_non_nullable
as String?,coverImageSource: freezed == coverImageSource ? _self.coverImageSource : coverImageSource // ignore: cast_nullable_to_non_nullable
as String?,coverImageCandidates: null == coverImageCandidates ? _self._coverImageCandidates : coverImageCandidates // ignore: cast_nullable_to_non_nullable
as List<TripCoverCandidate>,budgetTarget: freezed == budgetTarget ? _self.budgetTarget : budgetTarget // ignore: cast_nullable_to_non_nullable
as double?,budgetEstimated: freezed == budgetEstimated ? _self.budgetEstimated : budgetEstimated // ignore: cast_nullable_to_non_nullable
as double?,budgetActual: freezed == budgetActual ? _self.budgetActual : budgetActual // ignore: cast_nullable_to_non_nullable
as double?,origin: freezed == origin ? _self.origin : origin // ignore: cast_nullable_to_non_nullable
