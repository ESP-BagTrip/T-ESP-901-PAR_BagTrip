...
mixin _$Trip {
 ...
 String get id; String? get userId; String? get title; String? get originIata; String? get destinationIata; DateTime? get startDate; DateTime? get endDate;@TripStatusConverter() TripStatus get status; String? get description;@JsonKey(name: 'destinationName') String? get destinationName; String? get destinationTimezone; int? get nbTravelers; String? get coverImageUrl; double? get budgetTotal; String? get origin; String? get role; DateTime? get createdAt; DateTime? get updatedAt;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,userId,title,originIata,destinationIata,startDate,endDate,status,description,destinationName,destinationTimezone,nbTravelers,coverImageUrl,budgetTotal,origin,role,createdAt,updatedAt);

@override
String toString() {
  return 'Trip(id: $id, userId: $userId, title: $title, originIata: $originIata, destinationIata: $destinationIata, startDate: $startDate, endDate: $endDate, status: $status, description: $description, destinationName: $destinationName, destinationTimezone: $destinationTimezone, nbTravelers: $nbTravelers, coverImageUrl: $coverImageUrl, budgetTotal: $budgetTotal, origin: $origin, role: $role, createdAt: $createdAt, updatedAt: $updatedAt)';
}
...
@useResult
$Res call({
 String id, String? userId, String? title, String? originIata, String? destinationIata, DateTime? startDate, DateTime? endDate,@TripStatusConverter() TripStatus status, String? description,@JsonKey(name: 'destinationName') String? destinationName, String? destinationTimezone, int? nbTravelers, String? coverImageUrl, double? budgetTotal, String? origin, String? role, DateTime? createdAt, DateTime? updatedAt
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String? userId,  String? title,  String? originIata,  String? destinationIata,  DateTime? startDate,  DateTime? endDate, @TripStatusConverter()  TripStatus status,  String? description, @JsonKey(name: 'destinationName')  String? destinationName,  String? destinationTimezone,  int? nbTravelers,  String? coverImageUrl,  double? budgetTotal,  String? origin,  String? role,  DateTime? createdAt,  DateTime? updatedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Trip() when $default != null:
return $default(_that.id,_that.userId,_that.title,_that.originIata,_that.destinationIata,_that.startDate,_that.endDate,_that.status,_that.description,_that.destinationName,_that.destinationTimezone,_that.nbTravelers,_that.coverImageUrl,_that.budgetTotal,_that.origin,_that.role,_that.createdAt,_that.updatedAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String? userId,  String? title,  String? originIata,  String? destinationIata,  DateTime? startDate,  DateTime? endDate, @TripStatusConverter()  TripStatus status,  String? description, @JsonKey(name: 'destinationName')  String? destinationName,  String? destinationTimezone,  int? nbTravelers,  String? coverImageUrl,  double? budgetTotal,  String? origin,  String? role,  DateTime? createdAt,  DateTime? updatedAt)  $default,) {final _that = this;
switch (_that) {
case _Trip():
return $default(_that.id,_that.userId,_that.title,_that.originIata,_that.destinationIata,_that.startDate,_that.endDate,_that.status,_that.description,_that.destinationName,_that.destinationTimezone,_that.nbTravelers,_that.coverImageUrl,_that.budgetTotal,_that.origin,_that.role,_that.createdAt,_that.updatedAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String? userId,  String? title,  String? originIata,  String? destinationIata,  DateTime? startDate,  DateTime? endDate, @TripStatusConverter()  TripStatus status,  String? description, @JsonKey(name: 'destinationName')  String? destinationName,  String? destinationTimezone,  int? nbTravelers,  String? coverImageUrl,  double? budgetTotal,  String? origin,  String? role,  DateTime? createdAt,  DateTime? updatedAt)?  $default,) {final _that = this;
switch (_that) {
case _Trip() when $default != null:
return $default(_that.id,_that.userId,_that.title,_that.originIata,_that.destinationIata,_that.startDate,_that.endDate,_that.status,_that.description,_that.destinationName,_that.destinationTimezone,_that.nbTravelers,_that.coverImageUrl,_that.budgetTotal,_that.origin,_that.role,_that.createdAt,_that.updatedAt);case _:
  return null;
...
class _Trip implements Trip {
  const _Trip({required this.id, this.userId, this.title, this.originIata, this.destinationIata, this.startDate, this.endDate, @TripStatusConverter() this.status = TripStatus.draft, this.description, @JsonKey(name: 'destinationName') this.destinationName, this.destinationTimezone, this.nbTravelers, this.coverImageUrl, this.budgetTotal, this.origin, this.role, this.createdAt, this.updatedAt});
...
@override@JsonKey(name: 'destinationName') final  String? destinationName;
