...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,userId,title,originIata,destinationIata,startDate,endDate,status,description,destinationName,destinationTimezone,destinationLatitude,destinationLongitude,nbTravelers,coverImageUrl,budgetTarget,budgetEstimated,budgetActual,origin,role,completionPercentage,flightsTracking,accommodationsTracking,createdAt,updatedAt]);

@override
String toString() {
  return 'Trip(id: $id, userId: $userId, title: $title, originIata: $originIata, destinationIata: $destinationIata, startDate: $startDate, endDate: $endDate, status: $status, description: $description, destinationName: $destinationName, destinationTimezone: $destinationTimezone, destinationLatitude: $destinationLatitude, destinationLongitude: $destinationLongitude, nbTravelers: $nbTravelers, coverImageUrl: $coverImageUrl, budgetTarget: $budgetTarget, budgetEstimated: $budgetEstimated, budgetActual: $budgetActual, origin: $origin, role: $role, completionPercentage: $completionPercentage, flightsTracking: $flightsTracking, accommodationsTracking: $accommodationsTracking, createdAt: $createdAt, updatedAt: $updatedAt)';
}
...
as String?,budgetTarget: freezed == budgetTarget ? _self.budgetTarget : budgetTarget // ignore: cast_nullable_to_non_nullable
...
class _Trip implements Trip {
  const _Trip({required this.id, this.userId, this.title, this.originIata, this.destinationIata, this.startDate, this.endDate, @TripStatusConverter() this.status = TripStatus.draft, this.description, @JsonKey(name: 'destination_name') this.destinationName, this.destinationTimezone, this.destinationLatitude, this.destinationLongitude, this.nbTravelers, this.coverImageUrl, this.budgetTarget, this.budgetEstimated, this.budgetActual, this.origin, this.role, this.completionPercentage = 0, this.flightsTracking = 'TRACKED', this.accommodationsTracking = 'TRACKED', this.createdAt, this.updatedAt});
