...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,tripId,title,description,date,startTime,endTime,location,category,estimatedCost,isBooked,isDone,validationStatus,suggestedDay,createdAt,updatedAt);

@override
String toString() {
  return 'Activity(id: $id, tripId: $tripId, title: $title, description: $description, date: $date, startTime: $startTime, endTime: $endTime, location: $location, category: $category, estimatedCost: $estimatedCost, isBooked: $isBooked, isDone: $isDone, validationStatus: $validationStatus, suggestedDay: $suggestedDay, createdAt: $createdAt, updatedAt: $updatedAt)';
}
