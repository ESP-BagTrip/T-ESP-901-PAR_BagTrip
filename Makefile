...
install: install-uv setup-scripts check-docker setup-env setup-pre-commit setup-api setup-admin setup-bagtrip setup-linters ## Install dependencies for all services and set up development environment (fully automatic)
	@echo ""
