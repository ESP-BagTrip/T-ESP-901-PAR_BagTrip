...
vi.mock('@/features/travelers/hooks', () => ({
...
vi.mock('@/features/travelers/columns', () => ({ travelersColumns: [] }))
...
describe('TravelersPage', () => {
  ...
  it('renders description', () => {
    render(<TravelersPage />)
    expect(screen.getByText('Détails des voyageurs enregistrés.')).toBeInTheDocument()
  })

  it('passes loading state', () => {
    vi.mocked(useTravelersTab).mockReturnValueOnce({
      rows: [],
      isLoading: true,
      page: 1,
      limit: 10,
