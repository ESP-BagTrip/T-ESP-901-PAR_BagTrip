...
vi.mock('@/features/trip-shares/hooks', () => ({
  useTripSharesTab: vi.fn(() => ({
    rows: [],
    isLoading: false,
    page: 1,
    limit: 10,
...
vi.mock('@/features/trip-shares/columns', () => ({ tripSharesColumns: [] }))

import { useTripSharesTab } from '@/features/trip-shares/hooks'
import TripSharesPage from './page'

describe('TripSharesPage', () => {
  it('renders the page heading', () => {
    render(<TripSharesPage />)
    expect(screen.getByText('Partages de voyage')).toBeInTheDocument()
  })
  ...
  it('renders description', () => {
    render(<TripSharesPage />)
    expect(screen.getByText('Invitations de collaboration.')).toBeInTheDocument()
  })

  it('passes loading state', () => {
    vi.mocked(useTripSharesTab).mockReturnValueOnce({
      rows: [],
      isLoading: true,
      page: 1,
      limit: 10,
