...
vi.mock('@/features/budget-items/hooks', () => ({
...
vi.mock('@/features/budget-items/columns', () => ({ budgetItemsColumns: [] }))
...
describe('BudgetPage', () => {
  ...
  it('renders description', () => {
    render(<BudgetPage />)
    expect(screen.getByText('Lignes de budget et dépenses planifiées.')).toBeInTheDocument()
  })

  it('passes loading state', () => {
    vi.mocked(useBudgetItemsTab).mockReturnValueOnce({
