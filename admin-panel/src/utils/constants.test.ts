...
describe('API_ENDPOINTS', () => {
  ...
  describe('TRIPS', () => {
    ...
    it('generates correct FLIGHT_SEARCHES endpoint', () => {
      expect(API_ENDPOINTS.TRIPS.FLIGHT_SEARCHES('trip-1')).toBe('/v1/trips/trip-1/flights/searches')
    })
  ...
  describe('BOOKING_INTENTS', () => {
    ...
    it('generates correct BOOK endpoint', () => {
      expect(API_ENDPOINTS.BOOKING_INTENTS.BOOK(intentId)).toBe(`/v1/booking-intents/${intentId}/book`)
    })
