    ...
    <div className="min-h-screen bg-white">
          ...
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center">
              <div className="flex-shrink-0">
                <span className="text-2xl font-bold text-blue-600" data-cy="logo">BagTrip</span>
      ...
      <section className="bg-gradient-to-r from-blue-600 via-purple-600 to-indigo-600 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
          <div className="text-center">
            ...
            <p className="text-xl md:text-2xl mb-8 max-w-3xl mx-auto text-blue-100" data-cy="hero-subtitle">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {stats.map((stat, index) => (
              <div key={index} className="bg-white p-6 rounded-xl shadow-lg text-center" data-cy={`stat-${index}`}>
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {/* Tab Content */}
          {activeTab === 'features' && (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8" data-cy="features-grid">
              {features.map((feature, index) => (
                <div key={index} className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow" data-cy={`feature-${index}`}>
      ...
      <section className="py-20 bg-blue-600">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xl text-blue-100 mb-8">
            Testez dès maintenant notre interface d&apos;administration avec des données de démonstration
          </p>
          <div className="flex justify-center">
            <Link
              href="/login"
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="col-span-1 md:col-span-2">
              <div className="flex items-center mb-4">
                ...
                <span className="ml-2 px-2 py-1 text-xs bg-blue-900 text-blue-200 rounded">Admin</span>
              </div>
              <p className="text-gray-300 mb-4">
                Interface d&apos;administration moderne pour la gestion complète 
                de votre plateforme de voyage.
              </p>
            ...
            <div>
              <h3 className="text-lg font-semibold mb-4" data-cy="footer-links-title">Liens utiles</h3>
