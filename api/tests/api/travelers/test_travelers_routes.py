...
def mock_traveler():
    ...
    traveler.documents = []
    traveler.contacts = {}
    traveler.created_at = datetime.utcnow()
...
class TestCreateTraveler:
    ...
    def test_create_traveler_success(self, mock_service, client, override_get_current_user, override_get_db, mock_traveler):
    ...
    @patch("src.api.travelers.routes.TravelersService")
    def test_create_traveler_error(self, mock_service, client, override_get_current_user, override_get_db):
...
class TestListTravelers:
    ...
    @patch("src.api.travelers.routes.TravelersService")
    def test_list_travelers_success(self, mock_service, client, override_get_current_user, override_get_db, mock_traveler):
    ...
    @patch("src.api.travelers.routes.TravelersService")
    def test_list_travelers_error(self, mock_service, client, override_get_current_user, override_get_db):
...
class TestUpdateTraveler:
    ...
    @patch("src.api.travelers.routes.TravelersService")
    def test_update_traveler_success(self, mock_service, client, override_get_current_user, override_get_db, mock_traveler):
    ...
    @patch("src.api.travelers.routes.TravelersService")
    def test_update_traveler_error(self, mock_service, client, override_get_current_user, override_get_db):
...
class TestDeleteTraveler:
    ...
    @patch("src.api.travelers.routes.TravelersService")
    def test_delete_traveler_success(self, mock_service, client, override_get_current_user, override_get_db):
    ...
    @patch("src.api.travelers.routes.TravelersService")
    def test_delete_traveler_error(self, mock_service, client, override_get_current_user, override_get_db):
