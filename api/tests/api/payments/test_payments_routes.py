...
class TestAuthorizePayment:
    ...
    @patch("src.api.payments.routes.StripePaymentsService")
    def test_authorize_payment_error(self, mock_service, client, override_get_current_user, override_get_db):
...
class TestCapturePayment:
    ...
    @patch("src.api.payments.routes.StripePaymentsService")
    def test_capture_payment_error(self, mock_service, client, override_get_current_user, override_get_db):
        """Test capture error."""
        intent_id = uuid.uuid4()
...
class TestCancelPayment:
    ...
    @patch("src.api.payments.routes.StripePaymentsService")
    def test_cancel_payment_error(self, mock_service, client, override_get_current_user, override_get_db):
...
class TestConfirmPaymentTest:
    ...
    @patch("src.api.payments.routes.StripePaymentsService")
    def test_confirm_payment_test_error(self, mock_service, client, override_get_current_user, override_get_db):
