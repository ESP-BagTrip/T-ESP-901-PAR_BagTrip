...
_CONTINENT_KEYWORDS: dict[str, list[str]] = {
    "europe": [
        "paris", "london", "rome", "berlin", "madrid", "barcelona", "amsterdam",
        "vienna", "prague", "lisbon", "athens", "zurich", "brussels", "dublin",
        "stockholm", "oslo", "copenhagen", "helsinki", "warsaw", "budapest",
        "france", "spain", "italy", "germany", "portugal", "greece", "uk",
        "england", "switzerland", "netherlands", "belgium", "austria", "sweden",
        "norway", "denmark", "finland", "poland", "hungary", "czech",
    ],
    "asia": [
        "tokyo", "beijing", "shanghai", "bangkok", "singapore", "seoul",
        "mumbai", "delhi", "dubai", "istanbul", "hong kong", "taipei",
        "kuala lumpur", "hanoi", "bali", "jakarta",
        "japan", "china", "thailand", "india", "vietnam", "indonesia",
        "malaysia", "korea", "taiwan", "philippines", "uae", "turkey",
    ],
    "north_america": [
        "new york", "los angeles", "chicago", "miami", "san francisco",
        "toronto", "vancouver", "mexico city", "cancun", "montreal",
        "usa", "canada", "mexico", "united states",
    ],
    "south_america": [
        "rio", "buenos aires", "lima", "bogota", "santiago", "sao paulo",
        "brazil", "argentina", "colombia", "peru", "chile",
    ],
    "africa": [
        "cairo", "cape town", "marrakech", "nairobi", "lagos", "casablanca",
        "egypt", "morocco", "south africa", "kenya", "nigeria", "tunisia",
    ],
    "oceania": [
